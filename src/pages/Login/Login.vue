            ...
            <div :class="{on:loginWay}">
              <section class="login_message">
                ...
                <button  class="get_verification" :class="{right_phone:rightPhone}"
                        @click.prevent="getCode">{{computeTime> 0 ? `已发送${computeTime}`:'获取验证码'}}</button>
              </section>
            ...
            <div :class="{on:!loginWay}">
              <section>
                ...
                <section class="login_verification">
                  ...
                  <div class="switch_button"  @click="ChangPwdType" :class="showPwd ? 'off':'on'">
